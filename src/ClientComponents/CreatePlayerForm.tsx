...
import { Box, Button, ButtonGroup, Divider, Fade, Paper, Stack, TextField } from "@mui/material";
            ...
            <Fade in={ show } timeout={ { enter: 1000, exit: 500 } }>
                <Paper elevation={ 2 } sx={ { p: 2 } }>
                    ...
                    <ButtonGroup orientation={ 'vertical' } fullWidth >
                        ...
                        <Button color="warning" LinkComponent={ Link } href={ '/admin/players' } variant="contained" fullWidth>
                            Закрыть
                        </Button>
                    </ButtonGroup>
                </Paper>
